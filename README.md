...
1. **Upload Resume** – Supports `.pdf`, `.docx`, `.txt`  
2. **Extract Text** – Reads all content from your resume  
3. **Detect Skills** – Matches your resume against **technical** and **soft skills** lists  
4. **Predict Careers** – Uses **machine learning** to suggest the **top 5 careers**  
5. **Identify Missing Skills** – Compares your skills with what’s required for your top career
